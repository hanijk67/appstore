 ...
 */
package com.fanap.midhco.ui.component.ace;

import com.fanap.midhco.ui.component.ace.js.JsAceEditor;
import com.fanap.midhco.ui.component.ace.resource.AceResourceLocator;
import com.fanap.midhco.ui.component.ace.resource.IAceResourceLocator;
...
public class AceEditorField<T> extends TextArea<T> {
    ...
    public void renderHead(IHeaderResponse response) {
        response.render(OnDomReadyHeaderItem.forScript("$('#" + editor.getIdentifier() + "').autosize();"));
