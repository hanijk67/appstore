        ...
        if (e) {
            this.each(function() {
                ...
                function h(l) {
                    ...
                    $("#" + l.id + ".plupload_done .ui-icon").click(function(r) {
                        alert('7777');
                        //g("#" + p.id).remove();
                        //j.removeFile(p);
                        //r.preventDefault()
                ...
                function g() {
                    ...
                    c.each(j.files, function(p, o) {
                        ...
                        $("#" + o.id + '.plupload_done').find('div[jid="mine"]').remove();

                        $("#" + o.id + '.plupload_done')
                            .prepend('<div class="plupload_file_action" jid="mine"><a class="plupload_delete" style="display:block;" href="#"></a></div>')
                            .find('div[jid="mine"]')
                            .children('a')
