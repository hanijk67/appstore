...
public class ResultStatus {
    ...
    public static ResultStatus UNDELETED_APP_FOUND = new ResultStatus(31);
    public static ResultStatus INVALID_APP = new ResultStatus(32);
    public static ResultStatus NOT_APP_DEVELOPER = new ResultStatus(33);
    public static ResultStatus IMAGES_NOT_FOUND = new ResultStatus(34);
    public static ResultStatus COMPLAINT_EMAIL_NOT_FOUND = new ResultStatus(35);
    public static ResultStatus PROBLEM_IN_SENDING_EMAIL = new ResultStatus(36);
    public static ResultStatus ALREADY_APPROVED = new ResultStatus(37);
    public static ResultStatus ALREADY_DIS_APPROVED = new ResultStatus(38);
